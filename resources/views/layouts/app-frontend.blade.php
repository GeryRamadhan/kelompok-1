...
<head>
    ...
    <script src="{{asset('assets/js/jquery.BlackAndWhite.js')}}"></script>
...
<div class="preloader_hide">
    ...
    <div id="page">
        ...
        <section id="home" class="padbot0">
            ...
            <div id="carousel">
                <ul class="slides">
                    <li><img src="{{asset('assets/images/slider/slide1_bg.jpg')}}" alt="" /></li>
                    <li><img src="{{asset('assets/images/slider/slide2_bg.jpg')}}" alt="" /></li>
                    <li><img src="{{asset('assets/images/slider/slide3_bg.jpg')}}" alt="" /></li>
                </ul>
            </div><!-- //TOP SLIDER -->
        </section><!-- //HOME -->
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-5 ipad_img_in" data-appear-top-offset="-200" data-animated="fadeInRight">
                            <img class="ipad_img1" src="{{asset('assets/images/img1.png')}}" alt="" />
                        </div>
                    </div><!-- //ROW -->
                </div><!-- //CONTAINER -->
            </div><!-- //MULTI PURPOSE -->
            ...
            <div class="projects-wrapper" data-appear-top-offset="-200" data-animated="fadeInUp">
                ...
                <div class="owl-demo owl-carousel projects_slider">
                    ...
                    <div class="item">
                        <div class="work_item">
                            <div class="work_img">
                                ...
                                <a class="zoom" href="{{asset('assets/images/works/1.jpg')}}" rel="prettyPhoto[portfolio1]" ></a>
                            </div>
                    ...
                    <div class="item">
                        <div class="work_item">
                            <div class="work_img">
                                ...
                                <a class="zoom" href="{{asset('assets/images/works/2.jpg')}}" rel="prettyPhoto[portfolio1]" ></a>
                            </div>
                            <div class="work_description">
                                <div class="work_descr_cont">
                                    <a href="portfolio-post.html" >Ginger Beast</a>
                    ...
                    <div class="item">
                        <div class="work_item">
                            <div class="work_img">
                                ...
                                <a class="zoom" href="{{asset('assets/images/works/3.jpg')}}" rel="prettyPhoto[portfolio1]" ></a>
                            </div>
                            <div class="work_description">
                                <div class="work_descr_cont">
                                    <a href="portfolio-post.html" >Ginger Beast</a>
                    ...
                    <div class="item">
                        <div class="work_item">
                            <div class="work_img">
                                ...
                                <a class="zoom" href="{{asset('assets/images/works/4.jpg')}}" rel="prettyPhoto[portfolio1]" ></a>
                            </div>
                            <div class="work_description">
                                <div class="work_descr_cont">
                                    <a href="portfolio-post.html" >Ginger Beast</a>
                    ...
                    <div class="item">
                        <div class="work_item">
                            <div class="work_img">
                                ...
                                <a class="zoom" href="{{asset('assets/images/works/5.jpg')}}" rel="prettyPhoto[portfolio1]" ></a>
                            </div>
                            <div class="work_description">
                                <div class="work_descr_cont">
                                    <a href="portfolio-post.html" >Ginger Beast</a>
                    ...
                    <div class="item">
                        <div class="work_item">
                            <div class="work_img">
                                ...
                                <a class="zoom" href="{{asset('assets/images/works/6.jpg')}}" rel="prettyPhoto[portfolio1]" ></a>
                            </div>
                            <div class="work_description">
                                <div class="work_descr_cont">
                                    <a href="portfolio-post.html" >Ginger Beast</a>
                    ...
                    <div class="item">
                        <div class="work_item">
                            <div class="work_img">
                                <img src="{{asset('assets/images/works/7.jpg')}}" alt="" />
                                <a class="zoom" href="{{asset('assets/images/works/7.jpg')}}" rel="prettyPhoto[portfolio1]" ></a>
                            </div>
                            <div class="work_description">
                                <div class="work_descr_cont">
                                    <a href="portfolio-post.html" >Ginger Beast</a>
                ...
                <div class="container" data-appear-top-offset="-200" data-animated="fadeInUp">
                    ...
                    <div class="row">
                        <div class="col-lg-2 col-md-2 col-sm-2 client_img">
                            <img src="{{asset('assets/images/clients/1.jpg')}}" alt="" />
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 client_img">
                            <img src="{{asset('assets/images/clients/2.jpg')}}" alt="" />
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 client_img">
                            <img src="{{asset('assets/images/clients/3.jpg')}}" alt="" />
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 client_img">
                            <img src="{{asset('assets/images/clients/4.jpg')}}" alt="" />
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 client_img">
                            <img src="{{asset('assets/images/clients/5.jpg')}}" alt="" />
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 client_img">
                            <img src="{{asset('assets/images/clients/6.jpg')}}" alt="" />
                        </div>
                    </div><!-- //ROW -->
                </div><!-- CONTAINER -->
            </div><!-- //OUR CLIENTS -->
